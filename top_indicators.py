...
days_after_halvening = DaysAfterHalvening("Top after halvening", "Price has historically reached a peak 400-500 days after halvening events", indicator_type=Indicator.LEADING)
...
gbtc = GBTC("GBTC over NAV", "Last run GBTC market price traded at a peak of 2x NAV at the top. Looking for 1.8x. VanEck ETF may reduce NAV differential",
		units="dollars")
...
fear_and_greed = FearAndGreed("Fear & Greed Index", "Good short-term indicator on whether or not the market is greedy. >80 is very concerning. >90 is gtfo.",
		units="index")
...
top_cap = TopCap("Top Cap", "Bitcoin appears to hit tops when it's at 35x its forever average market cap. Targeting x32", units="dollars")
...
mayer_multiple = MayerMultiple("Mayer Multiple", "Last bull run was ~3.8 at peak, this is declining though so targeting 3.1 (which is just a guess based on nothing)", units="ratio")
